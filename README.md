...
| File/Directory | Purpose | Size | Last Updated |
|----------------|---------|------|-------------|
| `BankChurners.csv` | Raw customer data | 2.1 MB | Static |
| `BankChurners_Analysis.ipynb` | Complete analysis workflow | 15 MB | Active |
| `dashboard_metrics_report.pdf` | Executive summary | 850 KB | Generated |
| `requirements.txt` | Python dependencies | 2 KB | Maintained |
